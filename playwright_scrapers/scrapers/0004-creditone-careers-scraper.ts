...
async function scrapeCreditOneCareers() {
    console.log("Running Scraper 0004 - Credit One Careers");
    ...
    try {
        ...
        await page.selectOption(`#cateogry`, SEARCH_INFORMATION_TECHNOLOGY);
        ...
        await browser.close();
        console.log("\n Finished Running - Scraper 0004 - Credit One Careers");
    }
}
